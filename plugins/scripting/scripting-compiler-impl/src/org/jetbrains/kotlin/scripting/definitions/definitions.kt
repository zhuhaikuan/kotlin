...
fun PsiFile.findScriptDefinition(): ScriptDefinition? {
    ...
    return KtFileScriptSource(this).findScriptDefinition(project)
}
...
fun VirtualFile.findScriptDefinition(project: Project): ScriptDefinition? {
    ...
    return VirtualFileScriptSource(this).findScriptDefinition(project)
}

fun SourceCode.findScriptDefinition(project: Project): ScriptDefinition? {
    ...
    return scriptDefinitionProvider.findDefinition(this) ?: scriptDefinitionProvider.getDefaultDefinition()
}

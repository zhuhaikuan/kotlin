...
private fun FirExpression.hasErrorTypes(): Boolean {
    val visitor = ErrorTypeDetector()
    this.acceptChildren(visitor)
    return visitor.errorTypesDetected
}

private class ErrorTypeDetector : FirDefaultVisitorVoid() {
    var errorTypesDetected: Boolean = false
        private set
